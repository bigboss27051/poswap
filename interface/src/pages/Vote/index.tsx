      ...
      <TopSection gap="md">
        <VoteCard>
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.link color={'primaryText1'} fontWeight={600}>Uniswap Governance</TYPE.link>
              </RowBetween>
              <RowBetween>
              ...
              <ExternalLink
                ...
                target="_blank"
              >
                <TYPE.link color={'primaryText1'} fontSize={14}>Read more about Uniswap governance</TYPE.link>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
        </VoteCard>
